  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> Form Ubah Data Siswa</h3>
            <div class="row mt">
                <div class="col-lg-12">
                    <div class="form-panel">
                        <div class="form">
                            <form class="cmxform form-horizontal style-form" id="edit_siswa" action="proses_edit_siswa.php" method="POST">
                
                            <input type="hidden" name="id_siswa" value="<?php echo $siswa['id_siswa'] ?>" />
                            <div class="form-group ">
                                <label for="nama_lengkap" class="control-label col-lg-2">Nama Lengkap: </label>
                                <div class="col-lg-10">
                                <input type="text" class="form-control" name="nama_lengkap" placeholder="Nama Lengkap" value="<?php echo $siswa['nama_lengkap'] ?>" />
                                </div>
                            </div>
                            <div class="form-group ">
                                <label for="nama_panggilan" class="control-label col-lg-2">Nama Panggilan: </label>
                                <div class="col-lg-10">
                                <input type="text" class="form-control" name="nama_panggilan" placeholder="Nama Panggilan" value="<?php echo $siswa['nama_panggilan'] ?>"/>
                                </div>
                            </div>
                            <div class="form-group ">
