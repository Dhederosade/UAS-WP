  ...
  <section id="container">
      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li><a href="table_siswa.php">Table Siswa</a></li>
              <li class="active"><a href="table_guru.php">Table Guru</a></li>
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> Form Ubah Data Guru</h3>
            <div class="row mt">
                <div class="col-lg-12">
                    <div class="form-panel">
                        <div class="form">
                            <form class="cmxform form-horizontal style-form" id="edit_guru" action="proses_edit_guru.php" method="POST">
                            ...
                            <div class="form-group ">
                                ...
                                <div class="col-lg-10">
                                <input type="text" class="form-control" name="nama_lengkap" placeholder="Nama Lengkap" value="<?php echo $guru['nama_lengkap'] ?>" />
                                </div>
                            </div>
                            <div class="form-group ">
                                <label for="nip" class="control-label col-lg-2">NIP : </label>
                                <div class="col-lg-10">
                                <input type="text" class="form-control" name="nip" placeholder="NIP" value="<?php echo $guru['nip'] ?>"/>
                                </div>
                            </div>
                            <div class="form-group ">
                            ...
                            <div class="form-group ">
                                <label for="mata_pelajaran" class="control-label col-lg-2">Mata Pelajaran: </label>
                                <div class="col-lg-10">
                                <?php $mata_pelajaran = $guru['mata_pelajaran']; ?>
                                <select name="mata_pelajaran">
                                    <option <?php echo ($mata_pelajaran == 'PKN') ? "selected": "" ?>>PKN</option>
                                    <option <?php echo ($mata_pelajaran == 'Matematika') ? "selected": "" ?>>Matematika</option>
                                    <option <?php echo ($mata_pelajaran == 'IPA') ? "selected": "" ?>>IPA</option>
                                    <option <?php echo ($mata_pelajaran == 'IPS') ? "selected": "" ?>>IPS</option>
                                </select>
                                </div>
                            </div>
                            <div class="form-group ">
                                ...
                                <div class="col-lg-10">
                                <textarea name="alamat" class="form-control"><?php echo $guru['alamat'] ?> </textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-lg-offset-2 col-lg-10">
                                <button class="btn btn-theme" type="submit" value="simpan" name="simpan">Simpan</button>
                                </div>
                            </div>
                        </div>
                    </div>    
