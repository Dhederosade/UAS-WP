  ...
  <section id="container">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              ...
              <li class="active"><a href="form_guru.php">Data Guru</a></li>
            </ul>
          </li>
          <li class="sub-menu">
            <a href="javascript:;">
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> Form Guru</h3>
        <!-- /row -->
        <div class="row mt">
          <div class="col-lg-12">
            ...
            <div class="form-panel">
              <div class="form">
                <form class="cmxform form-horizontal style-form" id="signupForm" method="POST" action="simpan_guru.php">
                  ...
                  <div class="form-group ">
                    ...
                    <div class="col-lg-10">
                      <input class=" form-control" id="lastname" name="nip" type="text" />
                    </div>
                  </div>
                  <div class="form-group ">
                  ...
                  <div class="form-group ">
                    <label for="agama" class="control-label col-lg-2">Mata Pelajaran</label>
                    <div class="col-lg-10">
