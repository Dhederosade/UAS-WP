  ...
  <section id="container">
      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li class="active"><a href="form_siswa.php">Data Siswa</a></li>
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row mt">
          <div class="col-lg-12">
            <h4><i class="fa fa-angle-right"></i> Silahkan Isikan Sesuai Data Diri</h4>
            <div class="form-panel">
              <div class="form">
                <form class="cmxform form-horizontal style-form" id="simpan_siswa" method="post" action="simpan_siswa.php">
                  <div class="form-group ">
                    <label for="nama_lengkap" class="control-label col-lg-2">Nama Lengkap</label>  
                    <div class="col-lg-10">
                      <input class=" form-control" id="firstname" name="nama_lengkap" type="text" />
                    </div>
                  </div>
                  <div class="form-group ">
                    <label for="nama_panggilan" class="control-label col-lg-2">Nama Panggilan</label>
                    <div class="col-lg-10">
                      <input class=" form-control" id="lastname" name="nama_panggilan" type="text" />
                    </div>
                  </div>
                  <div class="form-group ">
                    <label for="jenis_kelamin" class="control-label col-lg-2">Jenis Kelamin</label>
                    <div class="col-lg-10">
                      <input type='radio' name='jenis_kelamin' value='pria' />Pria</p>
                  ...
                  <div class="form-group">
                    <div class="col-lg-offset-2 col-lg-10">
                      <button class="btn btn-theme" type="submit" value="save">Save</button>
