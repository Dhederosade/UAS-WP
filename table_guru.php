        ...
        <div class="row">
          <div class="col-md-12">
            <div class="content-panel">
              <h4><i class="fa fa-angle-right"></i> Silahkan Cek data diri Guru</h4>
              <hr>
              <table class="table">
                <thead>
                  <tr>
                ...
                <?php 
                  ...
                  while($guru = mysqli_fetch_array($query)){
                    ...
                    echo "<td>".$guru['nama_lengkap']."</td>";
                    echo "<td>".$guru['nip']."</td>";
                    echo "<td>".$guru['jenis_kelamin']."</td>";
                    echo "<td>".$guru['mata_pelajaran']."</td>";
                    echo "<td>".$guru['alamat']."</td>";
                    echo "<td>";
                    echo "<a href='form_edit_guru.php?id=".$guru['id_guru']."'>Edit |</a>";
                    echo "<a href='proses_hapus_guru.php?id=".$guru['id_guru']."'> Hapus</a>";
                ...
                ?>
                 <h4>Total Guru: <?php echo mysqli_num_rows($query) ?></h4>
                </tbody>
              </table>
            </div>
          </div>
